...
public class ReplyVoiceActivity {
    ...
    private void datapathreplyAnswer(String input){
        for(int i=0;i<arrayAdapter.getCount();i++){
            if(input.equals(arrayAdapter.getItem(i).toString())){//경로 직접 말하기
                text=arrayAdapter.getItem(i).toString()+"경로를 선택 하시겠습니까?";
                voiceActivity.speekTTS(text,tts);
        ...
        //Log.i("hyori","strings 사이즈 : "+arrayAdapter.getItem(1).toString());
