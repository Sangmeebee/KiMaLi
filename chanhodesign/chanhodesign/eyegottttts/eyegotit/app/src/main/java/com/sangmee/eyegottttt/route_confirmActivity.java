    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        delayHandler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                alarmCalendar.set(Calendar.MINUTE,tts.getMaxSpeechInputLength());
                alarmTime = alarmCalendar.getTimeInMillis();

                Log.i("hyori","초 : "+alarmTime);
            }
        }, alarmTime);
            ...
            public boolean onTouch(View view, MotionEvent e) {
                ...
                if(e.getAction() == MotionEvent.ACTION_MOVE){
                    ...
                    if (Math.abs(diffxx) > Math.abs(diffyy)) {
                        if (diffxx > MOVE_HAND) {
                            Intent intent = new Intent(route_confirmActivity.this, DatabaseActivity.class);
