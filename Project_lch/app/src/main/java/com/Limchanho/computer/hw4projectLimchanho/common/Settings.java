package com.Limchanho.computer.hw4projectLimchanho.common;
...
public class Settings {
    ...
    public int maxContinueBookingSlots;   // 한 유저가 연속으로 예약할 수 있는 슬롯 개수
    public int maxTotalBookingSlots;      // 한 유저가 하루에 예약할 수 있는 슬롯 개수
